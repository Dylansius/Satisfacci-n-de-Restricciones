...
# Función para seleccionar una variable no asignada
...
# Función para ordenar los valores del dominio de una variable
def order_domain_values(var, assignment, csp):
    return csp.domains[var]

# Función para comprobar la consistencia de una asignación
